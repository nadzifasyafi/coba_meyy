                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Welcome to SIMEKO!</h5>
                                                            ...
                                                            <div class="my-3 p-3 bg-body rounded shadow-sm">
                                                                <a href='{{ url('Stok') }}' class="btn btn-primary"><< Kembali</a>
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <input type="number" class="form-control" name='id'  id="id" value="{{ $data->id }}">
                                                                        </div>
                                                                    </div>
                                                                <div class="mb-3 row">
                                                                    <label for="nama_barang" class="col-sm-2 col-form-label">Nama Barang</label>
                                                                    <div class="col-sm-10">
                                                                        <input type="string" class="form-control" name='nama barang' value="{{ $data->nama_barang }}" id="nama barang">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="mb-3 row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="integer" class="form-control" name='jumlah barang' value="{{ $data->jumlah_barang }}" id="jumlah barang">
                                                                    </div>
                                                                </div>
                                                                <div class="mb-3 row">
                                                                    <label for="stok_awal" class="col-sm-2 col-form-label">Stok Awal</label>
                                                                    <div class="col-sm-10">
                                                                        <input type="integer" class="form-control" name='stok awal' value="{{ $data->stok_awal }}" id="stok awal">
                                                                    </div>
                                                                </div>
                                                                <div class="mb-3 row">
                                                                    <label for="stok_akhir" class="col-sm-2 col-form-label">Stok Akhir</label>
                                                                    <div class="col-sm-10">
                                                                        <input type="integer" class="form-control" name='stok akhir' value="{{ $data->stok_akhir }}" id="stok akhir">
                                                                    </div>
                                                                </div>
                                                                <div class="mb-3 row">
